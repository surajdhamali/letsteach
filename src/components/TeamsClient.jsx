    ...
    <div className="pt-14 min-h-screen">
      ...
      <section className="bg-zinc-950 px-6 py-20 overflow-hidden">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <Link href="/contact" className="text-sm font-semibold bg-amber-600 text-white px-7 py-3.5 rounded-full hover:bg-amber-500 transition-colors shadow-lg shadow-amber-900/30 hover:scale-105 active:scale-95">
              Talk to sales →
            </Link>
            <Link href="/courses" className="text-sm font-medium text-zinc-400 hover:text-white border-b border-zinc-600 hover:border-zinc-400 transition-colors pb-0.5">
      ...
      <section className="bg-white px-6 py-16 border-b border-zinc-100">
        <div className="max-w-6xl mx-auto">
          <FadeUp>
            <div className="text-xs font-semibold text-amber-600 uppercase tracking-widest mb-2">What's included</div>
          </FadeUp>
          <FadeUp delay={0.1}>
      ...
      <section className="bg-zinc-50 px-6 py-16 border-b border-zinc-100">
        <div className="max-w-4xl mx-auto">
          <FadeUp>
            <div className="text-xs font-semibold text-amber-600 uppercase tracking-widest mb-2">Getting started</div>
          </FadeUp>
          <FadeUp delay={0.1}>
          ...
          {STEPS.map((s, i) => (
            ...
            >
              <span className="font-display text-4xl font-bold text-zinc-200 group-hover:text-amber-300 transition-colors min-w-[3rem]">
                {s.n}
              </span>
              <div>
      ...
      <section className="bg-white px-6 py-16 border-b border-zinc-100">
        <div className="max-w-5xl mx-auto">
          <FadeUp>
            <div className="text-xs font-semibold text-amber-600 uppercase tracking-widest mb-2">Team pricing</div>
          </FadeUp>
          <FadeUp delay={0.1}>
            <h2 className="font-display text-4xl font-semibold tracking-tight mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {PLANS.map((plan, i) => (
              ...
              >
                ...
                <div className="mb-5">
                  <h3 className={`font-display text-xl font-semibold mb-1 ${plan.featured ? "text-white" : "text-zinc-900"}`}>
                    {plan.size}
                  </h3>
                  <p className={`text-xs mb-4 ${plan.featured ? "text-zinc-400" : "text-zinc-500"}`}>{plan.seats}</p>
                  <div className="flex items-baseline gap-1">
                    <span className={`font-display text-3xl font-bold tracking-tight ${plan.featured ? "text-amber-400" : "text-zinc-900"}`}>
                      {plan.price}
                    </span>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select className="w-full border border-zinc-200 rounded-xl px-4 py-2.5 text-sm text-zinc-700 focus:outline-none focus:border-amber-400 transition-colors bg-white">
                ...
                <div>
                  ...
                  <textarea rows={3} placeholder="e.g. We want to upskill our frontend engineers in React and system design..."
                ...
                <Link href="/contact"
                  className="block w-full text-center text-sm font-semibold bg-amber-600 text-white py-3 rounded-full hover:bg-amber-500 transition-colors hover:scale-[1.02] active:scale-95">
                  Send enquiry →
                </Link>
                <p className="text-xs text-zinc-400 text-center">
                  Or email us directly at{" "}
                  <a href="mailto:teams@letsteach.com" className="text-amber-600 hover:underline">teams@letsteach.com</a>
                </p>
              </div>
            </div>
          </FadeUp>
      ...
      <CTABand
        ...
        highlight="your team?"
        sub="Talk to us today. We'll have your team set up within 24 hours."
